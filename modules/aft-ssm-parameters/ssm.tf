...
resource "aws_ssm_parameter" "aft_account_provisioning_scp_workspace_id" {
  name  = "/aft/config/terraform/scp-workspace-id"
  value = var.aft_account_provisioning_scp_workspace_id
  type  = "String"
}